<template>
    <div class="mic-waves" :class="{ 'mic-waves--active': active }">
        <div class="mic-waves__talk-preview" v-if="active">
            {{ content || 'Estou te ouvindo!' }}
        </div>
...
<style lang="scss" scoped>
    .mic-waves {
        ...
        &__mic {
            ...
            fill: $color-white;
            fill-opacity: 0.65;
            transition: fill-opacity .4s ease-in-out;
        }
